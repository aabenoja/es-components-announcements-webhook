...
import { WebhookSubmission } from "../components/WebhookSubmission";
...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>ES Components Announcements</title>
        <meta name="description" content="Sign up for release announcements from es components" />
